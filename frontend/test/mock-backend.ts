  ...
  return {
    status: {
      ...
      rclone_invalidations: {
        ...
        last_successful_configured_call_at: "2026-07-02T08:05:00Z",
        runtime_last_error: null,
      },
      database: {
        provider: "sqlite",
        database_bytes: 5_368_709_120,
        wal_bytes: 4_194_304,
        shared_memory_bytes: 32_768,
        page_size_bytes: 4_096,
        page_count: 1_310_720,
        freelist_pages: 128,
        freelist_bytes: 524_288,
        checkpoint_busy: 0,
        wal_frames: 1_024,
        checkpointed_frames: 1_000,
        checkpoint_backlog_bytes: 98_304,
        busy_retries: 2,
        lease_retries: 1,
        query_samples: 4_096,
        query_p95_ms: 3.2,
        query_p99_ms: 8.7,
        transaction_samples: 1_024,
        transaction_p95_ms: 5.4,
        transaction_p99_ms: 12.1,
        captured_at: "2026-07-02T08:05:00Z",
      },
      critical_path: Object.fromEntries([
        "add_file_blob_write",
        "add_file_nzb_scan",
      ...
      cache: {
        ...
        pending_fetches: 1,
        first_byte_reads: 42,
        first_byte_average_ms: 183.4,
        provider_fetch_errors: 0,
      },
      mount: {
        type: "rclone",
        ...
        message: "rclone mount is managed outside NZBDav and has not been verified",
        fuse_errors: 0,
        active_operations: 0,
      ...
      provider_diagnostics: [
        {
          ...
          cooldown_until: null,
          last_success_at: "2026-07-02T08:04:00Z",
